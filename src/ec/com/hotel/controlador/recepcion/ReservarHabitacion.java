...
public class ReservarHabitacion {
	...
	private void cargarDatosCliente() {
		...
		if(cliList.size() > 0) {
			...
			buscarCiente(cliente);
		}
			
	}
	
	public void buscarCiente(Cliente cli) {
		if(cli != null) {//tiene datos el cliente, se recupera
			txtNumeroDocumento.setText(cli.getNumeroDocumento());
			cboTipoDocumento.setText(cli.getTipoDocumento().getTipoDocumento());
